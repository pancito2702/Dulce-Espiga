...
namespace BakeryApp_v1.Controllers
{
    ...
    public class PedidoEmpleadoController : Controller
    {
        private readonly PedidoService pedidoService;
        private readonly EstadosPedidoService estadosPedidoService;
        public PedidoEmpleadoController(PedidoService pedidoService, EstadosPedidoService estadosPedidoService)
        {
        ...
        [HttpGet("/PedidoEmpleado/ObtenerTodosLosPedidos/{pagina}")]
        ...
        [HttpGet("/PedidoEmpleado/ObtenerPedidoDTOPorId/{idPedido}")]
