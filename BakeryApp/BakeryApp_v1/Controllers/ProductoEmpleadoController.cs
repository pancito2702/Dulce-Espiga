...
namespace BakeryApp_v1.Controllers
{
    ...
    public class ProductoEmpleadoController : Controller
    {
        private readonly ProductoService productoService;
        private readonly CategoriaService categoriaService;
        private readonly RecetaService recetaService;   
        private readonly IFuncionesUtiles funcionesUtiles;
        public ProductoEmpleadoController(ProductoService productoService, IFuncionesUtiles funcionesUtiles, CategoriaService categoriaService, RecetaService recetaService)
        {
        ...
        [HttpGet("/ProductoEmpleado/ObtenerProductos/{pagina}")]
        ...
        [HttpDelete("/ProductoEmpleado/EliminarProducto/{idProducto}")]
        [ValidateAntiForgeryToken]
        ...
        [HttpGet("/ProductoEmpleado/DevolverProductoEspecifico/{idProducto}")]
