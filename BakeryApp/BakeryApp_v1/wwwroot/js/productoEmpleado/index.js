...
function ObtenerTodosLosProductos(pagina) {
    fetch("/ProductoEmpleado/ObtenerProductos/"+pagina, {
        method: "GET",
        headers: {
...
function EliminarProducto(event) {
    ...
    fetch("/ProductoEmpleado/EliminarProducto/" + idProducto, {
        method: "DELETE",
        headers: {
            "X-Requested-With": "XMLHttpRequest",
...
function VerPaginaEditar(event) {
    ...
    var urlEditar = "/ProductoEmpleado/EditarProducto?idProducto=" + idProducto;
...
function ObtenerTodasLasPaginas() {
    ...
    fetch("/ProductoEmpleado/ObtenerTotalPaginas", {
        method: "GET",
        headers: {
            "X-Requested-With": "XMLHttpRequest",
        }
