...
function ObtenerTodosLosPedidos(pagina) {
    fetch("/PedidoEmpleado/ObtenerTodosLosPedidos/" + pagina, {
        method: "GET",
        headers: {
...
function CrearFilasTabla(respuesta) {
    ...
    respuesta.arregloPedidos.forEach(pedido => {
        ...
        fetch("/PedidoEmpleado/ObtenerEstadosPedido/", {
            method: "GET",
            headers: {
                "X-Requested-With": "XMLHttpRequest",
            }
...
function ActualizarEstadoPedido(event) {
    ...
    fetch("/PedidoEmpleado/ActualizarEstadoPedido", {
        method: "PUT",
        headers: {
...
function VerPaginaPedido(event) {
    ...
    var urlVer = "/PedidoEmpleado/VerPedido?idPedido=" + idPedido;
...
function ObtenerTodasLasPaginas() {
    fetch("/PedidoEmpleado/ObtenerTotalPaginas", {
        method: "GET",
        headers: {
            "X-Requested-With": "XMLHttpRequest",
        }
